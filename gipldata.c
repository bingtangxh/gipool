...
CharMapType const CharMap[]={
    ...
    ,{111,L"哥伦比娅","Columbina",HYDRO,5} /*"哥伦比娅·希珀塞莱尼娅"*/ /*"Columbina Hyposelenia"*/
...
WishPoolType const WishPool[]={
    ...
    ,{{81,83},{94,74,31},{0},5,3,2,2025,1,21,2025,2,11}
    ...
    ,{{112,105},{12,7,15},{0},6,4,1,2026,2,25,2026,3,17}
    ,{{33,27,22,19,17,16},{0},{0},6,4,11,2026,2,25,2026,3,17}
    ,{{101,99},{100,55,74},{0},6,4,2,2026,3,17,2026,4,7}
    ,{{114,91},{109,103,13},{0},6,5,1,2026,4,8,2026,4,28}
    ,{{104,106},{68,9,107},{0},6,5,2,2026,4,28,2026,5,19}
    ,{{85,83,76,84,70},{0},{0},6,5,12,2026,4,28,2026,5,19}

    ,{{115,108},{116,11,6},{0},6,6,1,2026,5,20,2026,6,9}
    ,{{113,93},{65,7,12},{0},6,6,2,2026,6,9,2026,6,30}
    ...
    ,{{118,81},{119,15,69},{0},7,0,1,2026,8,12,2026,9,1}
    ,{{105,102},{103,96,94},{0},7,0,2,2026,9,1,2026,9,22}
    ,{{120,121},{23,60,14},{0},7,1,1,2026,9,23,2026,10,13}
    ,{{101,99},{FSD},{0},7,1,2,2026,10,14,2026,11,4}/*
    ,{{,},{,,},{0},7,2,1,2026,11,4,2026,,}
    ,{{,},{,,},{0},7,2,2,2026,,,2026,,}
    ,{{,},{,,},{0},7,3,1,2026,12,16,2026,,}
    ,{{,},{,,},{0},7,3,2,2026,,,2026,,}
    ,{{,},{,,},{0},7,4,1,2027,,,2027,,}
    ,{{,},{,,},{0},7,4,2,2027,,,2027,,}
    ,{{,},{,,},{0},7,5,1,2027,,,2027,,}
